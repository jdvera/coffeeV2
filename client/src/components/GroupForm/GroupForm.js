...
const GroupForm = props =>
	...
	<form>
		...
		<div className="form-group">
			...
			<input type="password" id="retype" className="form-control" placeholder="Re-Type Password" name="retype" style={props.state.createNewUser ? { display: "block" } : { display: "none" }} value={props.state.retype} onChange={props.handleInputChange} />
		</div>
